...
import { loadCurricula, loadClasses, loadEstablishments, getEstablishmentName, getCurriculumName, getClassName } from '@/lib/courseData';
...
const Messages = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 h-[calc(100vh-120px)] flex flex-col">
      ...
      <div className="flex flex-col flex-grow md:flex-row md:gap-4">
        ...
        <div className={cn(
          ...
          {(currentRole === 'professeur' || currentRole === 'tutor' || currentRole === 'director' || currentRole === 'deputy_director' || currentRole === 'administrator') && (
            <div className="p-4 border-b border-border space-y-4 rounded-android-tile">
          ...
          <div className="flex justify-center gap-2 p-4 border-b border-border">
            <Button
              ...
              className="flex-1 rounded-android-tile"
            >
        ...
        <div className={cn(
          ...
          {isMobile && selectedContact && (
            <Button variant="outline" onClick={() => setSelectedContact(null)} className="mb-4 w-fit rounded-android-tile">
