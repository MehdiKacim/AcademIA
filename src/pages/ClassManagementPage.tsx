...
// Removed useSearchParams as tabs are no longer used
...
// Removed import for CreatorAnalyticsSection as it's no longer used here

const ClassManagementPage = () => {
  const { currentUser, currentRole } = useRole();
  const { openChat } = useCourseChat();
  // Removed searchParams and activeTab state
  ...
  return (
    <div className="space-y-8">
      ...
      {/* --- Établissements Section (Creator Only) --- */}
      {currentRole === 'creator' && (
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <School className="h-6 w-6 text-primary" /> Gérer les Établissements
            </CardTitle>
      ...
      {/* --- Cursus Section (Creator Only) --- */}
      {currentRole === 'creator' && (
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <LayoutList className="h-6 w-6 text-primary" /> Gérer les Cursus Scolaires
            </CardTitle>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <Users className="h-6 w-6 text-primary" /> Gérer les Classes
          </CardTitle>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <GraduationCap className="h-6 w-6 text-primary" /> Gérer les Élèves
          </CardTitle>
      ...
      {/* Removed CreatorAnalyticsSection from here */}
