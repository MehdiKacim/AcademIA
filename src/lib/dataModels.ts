import { ElementType, JSX } from "react"; // Import ElementType and JSX for NavItem
    ...
    // Removed Establishment interface and EstablishmentType
    ...
    // Removed interface for persistent notifications
    ...
    export interface NavItem {
      ...
      type: 'route' | 'category_or_action'; // Updated: Replaced 'category' and 'action' with 'category_or_action'
