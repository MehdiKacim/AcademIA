...
const Logo = ({ iconClassName, textClassName, showText = true }: LogoProps) => {
  return (
    <div className="flex items-center gap-2">
      ...
      {showText && (
        <h1 className={cn("text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary via-foreground to-primary bg-[length:200%_auto] animate-background-pan", textClassName)}>
          AcademIA
        </h1>
      )}
    </div>
