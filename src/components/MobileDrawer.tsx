    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          <motion.div
            className={cn(
              "fixed bottom-0 left-0 right-0 w-full h-[calc(100vh-68px)] bg-background rounded-t-lg shadow-lg flex flex-col overflow-hidden rounded-android-tile z-[999]", // Actual drawer content, highest z-index
              contentClassName
            )}
