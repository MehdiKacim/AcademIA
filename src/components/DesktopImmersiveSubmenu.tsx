    ...
    <AnimatePresence>
      {parentItem && (
        <motion.nav
          ...
          className="fixed top-[68px] left-0 right-0 z-40 hidden md:flex flex-col h-48 px-4 py-3 border-b backdrop-blur-lg bg-background/80 shadow-lg overflow-y-auto"
        >
