    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-full h-svh sm:max-w-[600px] sm:h-auto bg-card z-[1000] rounded-android-tile">
        <div className="flex flex-col h-full">
            ...
            {isParentSelectionStep ? (
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <MotionButton variant="ghost" size="sm" onClick={handleCancelParentSelection} whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
          ...
          <DialogFooter>
            <MotionButton onClick={handleSaveEditedRoleConfig} disabled={isSavingEdit || isParentSelectionStep} whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }}>
