...
const DEFAULT_NAV_ITEMS_WITH_KEYS = [
  ...
  { key: 'nav-notifications', label: 'Notifications', route: '/notifications', icon_name: 'BellRing', is_external: false, type: 'route' }, // New: Notifications
...
const DEFAULT_ROLE_NAV_CONFIGS_WITH_KEYS = {
  administrator: [
    ...
    { nav_item_key: 'nav-messages', parent_nav_item_key: null, order_index: 9 },
    { nav_item_key: 'nav-notifications', parent_nav_item_key: null, order_index: 10 }, // New: Notifications
    { nav_item_key: 'nav-profile', parent_nav_item_key: null, order_index: 11 },
    { nav_item_key: 'nav-settings', parent_nav_item_key: null, order_index: 12 },
    { nav_item_key: 'nav-admin-menu-management', parent_nav_item_key: null, order_index: 13 },
    ...
    { nav_item_key: 'nav-data-model', parent_nav_item_key: null, order_index: 14 },
    { nav_item_key: 'nav-global-search', parent_nav_item_key: null, order_index: 15 },
    { nav_item_key: 'nav-about', parent_nav_item_key: null, order_index: 16 },
    { nav_item_key: 'nav-aia-chat', parent_nav_item_key: null, order_index: 17 },
  ],
  director: [
    { nav_item_key: 'nav-dashboard', parent_nav_item_key: null, order_index: 0 },
    { nav_item_key: 'nav-admin-users', parent_nav_item_key: null, order_index: 1 },
    ...
    { nav_item_key: 'nav-notifications', parent_nav_item_key: null, order_index: 11 }, // New: Notifications
  ...
  professeur: [
    ...
    { nav_item_key: 'nav-notifications', parent_nav_item_key: null, order_index: 5 }, // New: Notifications
  ...
  tutor: [
    ...
    { nav_item_key: 'nav-notifications', parent_nav_item_key: null, order_index: 4 }, // New: Notifications
