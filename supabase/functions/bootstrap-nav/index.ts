...
const DEFAULT_NAV_ITEMS_WITH_KEYS = [
  ...
  { key: 'nav-establishments', label: 'Gestion des Établissements', route: '/establishments', icon_name: 'Building2', is_external: false, type: 'route' }, // New: Establishment Management
...
const DEFAULT_ROLE_NAV_CONFIGS_WITH_KEYS = {
  administrator: [
    ...
    { nav_item_key: 'nav-establishments', parent_nav_item_key: null, order_index: 2 }, // New: Establishment Management
    { nav_item_key: 'nav-subjects', parent_nav_item_key: null, order_index: 3 },
    { nav_item_key: 'nav-school-years', parent_nav_item_key: null, order_index: 4 },
    { nav_item_key: 'nav-professor-assignments', parent_nav_item_key: null, order_index: 5 },
    { nav_item_key: 'nav-curricula', parent_nav_item_key: null, order_index: 6 },
    { nav_item_key: 'nav-classes', parent_nav_item_key: null, order_index: 7 },
    { nav_item_key: 'nav-students', parent_nav_item_key: null, order_index: 8 },
    { nav_item_key: 'nav-pedagogical-management', parent_nav_item_key: null, order_index: 9 },
    { nav_item_key: 'nav-analytics', parent_nav_item_key: null, order_index: 10 },
    { nav_item_key: 'nav-messages', parent_nav_item_key: null, order_index: 11 },
    // Removed nav-notifications
    { nav_item_key: 'nav-profile', parent_nav_item_key: null, order_index: 13 },
    { nav_item_key: 'nav-settings', parent_nav_item_key: null, order_index: 14 },
    { nav_item_key: 'nav-admin-menu-management', parent_nav_item_key: null, order_index: 15 },
    ...
    { nav_item_key: 'nav-data-model', parent_nav_item_key: null, order_index: 16 },
    { nav_item_key: 'nav-global-search', parent_nav_item_key: null, order_index: 17 },
    { nav_item_key: 'nav-about', parent_nav_item_key: null, order_index: 18 },
    { nav_item_key: 'nav-aia-chat', parent_nav_item_key: null, order_index: 19 },
  ],
  director: [
    { nav_item_key: 'nav-dashboard', parent_nav_item_key: null, order_index: 0 },
    { nav_item_key: 'nav-admin-users', parent_nav_item_key: null, order_index: 1 },
