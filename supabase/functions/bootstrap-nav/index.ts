...
const DEFAULT_ROLE_NAV_CONFIGS_WITH_KEYS = {
  administrator: [
    ...
    { nav_item_key: 'nav-profile', parent_nav_item_key: null, order_index: 10 },
    { nav_item_key: 'nav-settings', parent_nav_item_key: null, order_index: 11 },
    { nav_item_key: 'nav-admin-menu-management', parent_nav_item_key: null, order_index: 12 },
    ...
    { nav_item_key: 'nav-data-model', parent_nav_item_key: null, order_index: 13 },
  ...
  director: [
    ...
    { nav_item_key: 'nav-global-search', parent_nav_item_key: null, order_index: 13 },
    { nav_item_key: 'nav-about', parent_nav_item_key: null, order_index: 14 },
    { nav_item_key: 'nav-aia-chat', parent_nav_item_key: null, order_index: 15 },
  ],
  deputy_director: [
    { nav_item_key: 'nav-dashboard', parent_nav_item_key: null, order_index: 0 },
    { nav_item_key: 'nav-admin-users', parent_nav_item_key: null, order_index: 1 },
  ...
  tutor: [
    ...
    { nav_item_key: 'nav-profile', parent_nav_item_key: null, order_index: 4 },
    { nav_item_key: 'nav-settings', parent_nav_item_key: null, order_index: 5 },
    { nav_item_key: 'nav-global-search', parent_nav_item_key: null, order_index: 6 },
    { nav_item_key: 'nav-about', parent_nav_item_key: null, order_index: 7 },
    { nav_item_key: 'nav-aia-chat', parent_nav_item_key: null, order_index: 8 },
  ],
  student: [
    { nav_item_key: 'nav-dashboard', parent_nav_item_key: null, order_index: 0 },
