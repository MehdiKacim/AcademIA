...
const DEFAULT_NAV_ITEMS_WITH_KEYS = [
  ...
  // Removed 'nav-messages', 'nav-notifications', 'nav-profile', 'nav-settings' as they will be static
  ...
  { key: 'nav-admin-menu-management', label: 'Gestion des Menus', route: '/admin-menu-management', icon_name: 'LayoutList', is_external: false, type: 'category_or_action' },
...
const DEFAULT_ROLE_NAV_CONFIGS_WITH_KEYS = {
  administrator: [
    ...
    { nav_item_key: 'nav-admin-menu-management', parent_nav_item_key: null, order_index: 9 },
    ...
    { nav_item_key: 'nav-data-model', parent_nav_item_key: null, order_index: 10 },
    { nav_item_key: 'nav-global-search', parent_nav_item_key: null, order_index: 11 },
    { nav_item_key: 'nav-about', parent_nav_item_key: null, order_index: 12 },
    { nav_item_key: 'nav-aia-chat', parent_nav_item_key: null, order_index: 13 },
  ],
  director: [
    { nav_item_key: 'nav-dashboard', parent_nav_item_key: null, order_index: 0 },
    { nav_item_key: 'nav-admin-users', parent_nav_item_key: null, order_index: 1 },
    ...
    { nav_item_key: 'nav-global-search', parent_nav_item_key: null, order_index: 10 },
    { nav_item_key: 'nav-about', parent_nav_item_key: null, order_index: 11 },
    { nav_item_key: 'nav-aia-chat', parent_nav_item_key: null, order_index: 12 },
  ],
  deputy_director: [
    { nav_item_key: 'nav-dashboard', parent_nav_item_key: null, order_index: 0 },
    { nav_item_key: 'nav-admin-users', parent_nav_item_key: null, order_index: 1 },
  ...
  professeur: [
    ...
    { nav_item_key: 'nav-global-search', parent_nav_item_key: null, order_index: 4 },
    { nav_item_key: 'nav-about', parent_nav_item_key: null, order_index: 5 },
    { nav_item_key: 'nav-aia-chat', parent_nav_item_key: null, order_index: 6 },
  ],
  tutor: [
    { nav_item_key: 'nav-dashboard', parent_nav_item_key: null, order_index: 0 },
    ...
    { nav_item_key: 'nav-global-search', parent_nav_item_key: null, order_index: 3 },
    { nav_item_key: 'nav-about', parent_nav_item_key: null, order_index: 4 },
    { nav_item_key: 'nav-aia-chat', parent_nav_item_key: null, order_index: 5 },
  ],
  student: [
    { nav_item_key: 'nav-dashboard', parent_nav_item_key: null, order_index: 0 },
